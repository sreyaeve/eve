...
wget -q -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/sreyaeve/eve/main/file/rclone.conf"
...
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/sreyaeve/eve/main/file/backup.sh" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/sreyaeve/eve/main/file/restore.sh" && chmod +x /usr/bin/restore
wget -q -O /usr/bin/cleaner "https://raw.githubusercontent.com/sreyaeve/eve/main/file/logcleaner.sh" && chmod +x /usr/bin/cleaner
