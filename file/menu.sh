...
echo -e " [\e[36m 07 \e[0m] Status Running & Info Service"
echo -e " [\e[36m 08 \e[0m] Clear RAM Cache"
echo -e " [\e[36m 09 \e[0m] Monitoring System"
echo -e " [\e[36m 10 \e[0m] Info Bandwidth"
echo -e " [\e[36m 11 \e[0m] Backup dan Restore Data"
echo -e " [\e[36m 12 \e[0m] Ubah Banner Login SSH"
echo -e " [\e[36m 13 \e[0m] Clear Log XRAY"
echo -e " [\e[36m 14 \e[0m] Reboot VPS"
echo -e   ""
